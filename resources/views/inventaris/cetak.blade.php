...
<div class="page">
    ...
    <div class="report-title-section">
        DAFTAR REALISASI PROGRAM SARANA PRASARANA MAN 3 HULU SUNGAI UTARA<br>
        PERIODE {{ $periode }}
    </div>
        ...
        <tbody>
            @forelse ($inventaris as $item)
                <tr>
                    ...
                    <td class="col-right">Rp. {{ number_format($item->biaya, 0, ',', '.') }}</td>
                    <td class="col-right">Rp. {{ number_format($item->total_biaya, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" class="col-center">Tidak ada data inventaris untuk periode ini.</td>
                </tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr>
                <td colspan="6" class="col-center"><strong>Jumlah Biaya</strong></td>
                <td class="col-right">Rp. {{ number_format($totalBiaya, 0, ',', '.') }}</td>
            </tr>
        </tfoot>
    </table>
