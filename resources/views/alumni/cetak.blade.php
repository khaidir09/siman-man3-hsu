...
<div class="page">
    ...
    <div class="report-title-section">
        DAFTAR ALUMNI MAN 3 HULU SUNGAI UTARA<br>
        PERIODE {{ $academic_period->tahun_ajaran }}
    </div>

    <table style="margin-bottom: 20px;">
        <tr>
            <th style="text-align: left;">Kuliah</th>
            <td>: {{ $jumlahAlumniKuliah }} orang</td>
        </tr>
        <tr>
            <th style="text-align: left;">Bekerja</th>
            <td>: {{ $jumlahAlumniBekerja }} orang</td>
        </tr>
        @if ($jumlahAlumniLainnya > 0)
        <tr>
            <th style="text-align: left;">Lainnya</th>
            <td>: {{ $jumlahAlumniLainnya }} orang</td>
        </tr>
        @endif
    </table>
