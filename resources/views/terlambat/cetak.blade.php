...
<head>
    ...
    <title>Laporan Pelanggaran Kedisiplinan</title>
    <style>
...
<div class="page">
    ...
    <div class="report-title-section">
        DAFTAR TERLAMBAT SISWA-SISWI MAN 3 HULU SUNGAI UTARA<br>
        PERIODE {{ $periode }}
    </div>
    ...
    <table class="report-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="col-center">Tidak ada data siswa datang terlambat untuk periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
